...
import { CxDropdownConfig } from './dropdown-config';
 ...
 */
@Directive({
  selector: '[cxDropdownItem]',
  host: { class: 'dropdown-item', '[class.disabled]': 'disabled' },
})
export class CxDropdownItem {
...
export class CxDropdownMenu {
  placement: Placement = 'bottom';
  isOpen = false;

  @ContentChildren(CxDropdownItem) menuItems: QueryList<CxDropdownItem>;

  constructor(
    @Inject(forwardRef(() => CxDropdown)) public dropdown,
  ...
  position(triggerEl, placement) {
    this.applyPlacement(
      positionElements(triggerEl, this._elementRef.nativeElement, placement)
    );
  }
 ...
 * of the CxDropdownToggle directive. It plays the same role as CxDropdownToggle but
...
/**
 * Allows the dropdown to be toggled via click. This directive is optional: you can use CxDropdownAnchor as an
 * alternative.
 */
@Directive({
  selector: '[cxDropdownToggle]',
  host: {
    class: 'dropdown-toggle',
    'aria-haspopup': 'true',
    '[attr.aria-expanded]': 'dropdown.isOpen()',
  ...
  providers: [
    {
      provide: CxDropdownAnchor,
      useExisting: forwardRef(() => CxDropdownToggle),
    },
  ],
})
export class CxDropdownToggle extends CxDropdownAnchor {
  constructor(
    @Inject(forwardRef(() => CxDropdown)) dropdown,
...
export class CxDropdown implements OnInit, OnDestroy {
  private _closed$ = new Subject<void>();
  private _zoneSubscription: Subscription;
  private _bodyContainer: HTMLElement;

  @ContentChild(CxDropdownMenu) private _menu: CxDropdownMenu;
  @ContentChild(CxDropdownMenu, { read: ElementRef })
  private _menuElement: ElementRef;

  @ContentChild(CxDropdownAnchor) private _anchor: CxDropdownAnchor;
