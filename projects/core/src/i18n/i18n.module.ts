...
import { TranslateOptionalPipe } from './translate-optional.pipe';

@NgModule({
  declarations: [TranslatePipe, TranslateOptionalPipe, DatePipe],
  exports: [TranslatePipe, TranslateOptionalPipe, DatePipe],
})
